...
import { Search, MessageCircle, FileSignature, Ship } from 'lucide-react';

const STEPS = [
  { num: '01', Icon: Search,        opacity: 'bg-primary-50 text-primary-700',  href: (locale: string) => `/${locale}/products` },
  { num: '02', Icon: MessageCircle, opacity: 'bg-primary-100 text-primary-700', href: null },
  { num: '03', Icon: FileSignature, opacity: 'bg-primary-200 text-primary-800', href: (locale: string) => `/${locale}/contract` },
  { num: '04', Icon: Ship,          opacity: 'bg-primary-300 text-primary-900', href: (locale: string) => `/${locale}/logistics` },
];
          ...
          {STEPS.map((step, i) => (
            <div key={step.num} className="relative">
              ...
              {step.href ? (
                ...
                >
                  <div className={`w-12 h-12 rounded-xl ${step.opacity} flex items-center justify-center mb-4`}>
